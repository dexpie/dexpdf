    ...
    return (
        <ToolLayout title="Slug Generator" description="Convert text into SEO-friendly URL slugs.">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="bg-card p-6 rounded-3xl shadow text-center">
                    <input
                        value={input} onChange={e => setInput(e.target.value)}
                        className="w-full text-center text-3xl font-bold text-foreground outline-none placeholder:text-slate-200"
                        placeholder="Enter text..."
                    />
                </div>

                <div className="flex justify-center">
                    <ArrowRight className="w-8 h-8 text-muted-foreground animate-bounce" />
                </div>
                ...
                <div className="bg-blue-600 p-8 rounded-3xl shadow-xl flex flex-col items-center gap-4">
                    ...
                    <button
                        ...
                        className="px-6 py-2 bg-card/20 hover:bg-card/30 text-white rounded-full font-bold text-sm transition-colors flex items-center gap-2"
                    >
