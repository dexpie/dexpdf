            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="bg-white p-6 rounded-3xl shadow-lg border border-slate-100">
                    ...
                    <textarea
                        ...
                        className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 ring-blue-500 font-mono text-sm h-24 resize-none text-slate-700"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-md border-l-4 border-blue-500">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-bold text-lg text-slate-700">Browser</h3>
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-md border-l-4 border-purple-500">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-bold text-lg text-slate-700">Operating System</h3>
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-md border-l-4 border-green-500">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-bold text-lg text-slate-700">Device</h3>
                            </div>
                            <div className="space-y-2">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-md border-l-4 border-orange-500">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-bold text-lg text-slate-700">CPU</h3>
                            </div>
                            <div className="space-y-2">
...
function InfoRow({ label, value }) {
    return (
        <div className="flex justify-between border-b border-slate-100 last:border-0 pb-1">
            <span className="text-sm text-slate-400 font-bold">{label}</span>
            <span className="text-sm text-slate-800 font-semibold">{value || 'N/A'}</span>
        </div>
    )
}
