        ...
        <ToolLayout title="JSON Diff" description="Compare two JSON objects semantically.">
            <div className="max-w-6xl mx-auto h-[700px] flex flex-col gap-6">
                ...
                <div className="grid grid-cols-2 gap-4 h-1/3">
                    <div className="flex flex-col bg-card rounded-2xl shadow-sm border border-border">
                        <div className="p-2 border-b text-xs font-bold text-muted-foreground uppercase bg-secondary rounded-t-2xl pl-4">Original JSON</div>
                        <textarea
                            value={left}
                    ...
                    <div className="flex flex-col bg-card rounded-2xl shadow-sm border border-border">
                        <div className="p-2 border-b text-xs font-bold text-muted-foreground uppercase bg-secondary rounded-t-2xl pl-4">New JSON</div>
                        <textarea
                            value={right}
