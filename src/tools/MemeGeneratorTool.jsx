    ...
    return (
        <ToolLayout title="Meme Generator" description="Add classic top/bottom text to any image.">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1 bg-slate-900/5 min-h-[400px] rounded-3xl flex items-center justify-center overflow-hidden border-2 border-dashed border-[hsl(var(--hairline)/0.4)]">
                    {!image ? (
