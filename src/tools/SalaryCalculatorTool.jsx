    ...
    return (
        <ToolLayout title="Salary Calculator" description="Convert between hourly, monthly, and annual income.">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="bg-card p-6 rounded-3xl shadow-lg border border-border grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-1 md:col-span-1">
                        <label className="text-xs font-bold text-muted-foreground uppercase">Per</label>
                        <select
                    ...
                    <div className="space-y-1 md:col-span-1">
                        <label className="text-xs font-bold text-muted-foreground uppercase">Hours/Week</label>
                        <input
